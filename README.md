...
- IndexNow ready for instant Bing indexing — see `INDEXNOW_KEY_PLACEHOLDER.txt`
- Shared sitemap, canonical URLs, structured data and internal linking across all pages
